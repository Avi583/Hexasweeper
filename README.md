...
Hexasweeper is a installable Progressive Web App (PWA) — it works fully offline once installed and launches like a native app.
...
Hexasweeper uses **pointy-top hexagons** laid out in an **"odd-r" offset grid** (odd rows shifted half a hex to the right), rendered as an SVG.
